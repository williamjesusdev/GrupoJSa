...
import io.github.williamjesusdev.grupojsa.core.security.jwt.JwtAuthFilter;
    ...
    protected void configure( HttpSecurity http ) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST,"/v1/empresas/**")
                    .hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/v1/empresas/**")
                    .permitAll()
